...
#if		defined( PLATFORM_MODIFICATION_DEFAULT )
#define HSE_VALUE				( 16000000ul )				// [Hz]	Внешний кварц на плате (быстрый)
...
#define GPIO_MKP002			GPIOC,	GPIO_PIN_13,		13		// PB0	D1.4	Управление скоростью оцифровки внешнего АЦП (ADS1231ID)
#define GPIO_MKP003			GPIOC,	GPIO_PIN_14,		14		// PB0	D1.4	Управление скоростью оцифровки внешнего АЦП (ADS1231ID)
#define GPIO_MKP004			GPIOC,	GPIO_PIN_15,		15		// PB0	D1.4	Управление скоростью оцифровки внешнего АЦП (ADS1231ID)
#define GPIO_MKP045			GPIOB,	GPIO_PIN_8,		8		// PB0	D1.4	Управление скоростью оцифровки внешнего АЦП (ADS1231ID)
#define GPIO_MKP046			GPIOB,	GPIO_PIN_9,		9		// PB0	D1.4	Управление скоростью оцифровки внешнего АЦП (ADS1231ID)
...
#define ASD_Pin				GPIO_PIN_1
#define AWRH_2byte_Pin 		GPIO_PIN_2
#define AWRL_1byte_Pin		GPIO_PIN_12
#define ARDL_1byte_Pin		GPIO_PIN_13
#define ANED_Pin			GPIO_PIN_14
#define AMODE_Pin			GPIO_PIN_15
#define ARDH_2byte_Pin		GPIO_PIN_5
#define ACHD_Pin			GPIO_PIN_7
...
#define AINTRX_Pin			GPIO_PIN_8
#define AINTTX_Pin			GPIO_PIN_11
#define DA_ALL 				DA0_Pin | DA1_Pin | DA2_Pin | DA3_Pin | DA4_Pin | DA5_Pin  | DA6_Pin | DA7_Pin
