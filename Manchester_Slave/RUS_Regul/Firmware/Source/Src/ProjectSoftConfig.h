...
#ifdef	PROJECT_NAME_RUS_REGUL		// базоваЯ версиЯ
	#define SKLP_ADDRESS_MYSELF				SKLP_ADDRESS_RUS_Pump		// Адрес модуля на шине СКЛ (широковещательный)
	#define SKLP_ADDRESS_CUSTOM 										// Адрес модуля на шине СКЛ зависит от джамперов
	#define	SKLP_DEVICE_TYPE_DEFAULT		0x3540						// Тип устройства длЯ команды [0x01]
	#define SKLP_DEVICE_TYPE				"RUS Regul"					// Тип устройства, отображаемый в логе
