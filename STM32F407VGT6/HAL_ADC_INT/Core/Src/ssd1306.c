...
/* Write command */
#define SSD1306_WRITECOMMAND(command, hi2c) ssd1306_I2C_Write(SSD1306_I2C_ADDR, 0x00, (command), (hi2c))
/* Write data */
...
{
  SSD1306_WRITECOMMAND (SSD1306_RIGHT_HORIZONTAL_SCROLL, hi2c);  // send 0x26
  SSD1306_WRITECOMMAND (0x00, hi2c);  // send dummy
  SSD1306_WRITECOMMAND(start_row, hi2c);  // start page address
  SSD1306_WRITECOMMAND(0X00, hi2c);  // time interval 5 frames
  SSD1306_WRITECOMMAND(end_row, hi2c);  // end page address
  SSD1306_WRITECOMMAND(0X00, hi2c);
  SSD1306_WRITECOMMAND(0XFF, hi2c);
  SSD1306_WRITECOMMAND (SSD1306_ACTIVATE_SCROLL, hi2c); // start scroll
}


void SSD1306_ScrollLeft(uint8_t start_row, uint8_t end_row, I2C_HandleTypeDef hi2c)
{
  SSD1306_WRITECOMMAND (SSD1306_LEFT_HORIZONTAL_SCROLL, hi2c);  // send 0x26
  SSD1306_WRITECOMMAND (0x00, hi2c);  // send dummy
  SSD1306_WRITECOMMAND(start_row, hi2c);  // start page address
  SSD1306_WRITECOMMAND(0X00, hi2c);  // time interval 5 frames
  SSD1306_WRITECOMMAND(end_row, hi2c);  // end page address
...
{
  SSD1306_WRITECOMMAND(SSD1306_SET_VERTICAL_SCROLL_AREA, hi2c);  // sect the area
  SSD1306_WRITECOMMAND (0x00, hi2c);   // write dummy
  SSD1306_WRITECOMMAND(SSD1306_HEIGHT, hi2c);

  SSD1306_WRITECOMMAND(SSD1306_VERTICAL_AND_RIGHT_HORIZONTAL_SCROLL, hi2c);
  SSD1306_WRITECOMMAND (0x00, hi2c);
  SSD1306_WRITECOMMAND(start_row, hi2c);
  SSD1306_WRITECOMMAND(0X00, hi2c);
  SSD1306_WRITECOMMAND(end_row, hi2c);
  SSD1306_WRITECOMMAND (0x01, hi2c);
  SSD1306_WRITECOMMAND (SSD1306_ACTIVATE_SCROLL, hi2c);
}
...
void SSD1306_Scrolldiagleft(uint8_t start_row, uint8_t end_row, I2C_HandleTypeDef hi2c)
{
  ...
  SSD1306_WRITECOMMAND(SSD1306_VERTICAL_AND_LEFT_HORIZONTAL_SCROLL, hi2c);
  SSD1306_WRITECOMMAND (0x00, hi2c);
  SSD1306_WRITECOMMAND(start_row, hi2c);
  SSD1306_WRITECOMMAND(0X00, hi2c);
  SSD1306_WRITECOMMAND(end_row, hi2c);
...
{
  if (i) SSD1306_WRITECOMMAND (SSD1306_INVERTDISPLAY, hi2c);

  else SSD1306_WRITECOMMAND (SSD1306_NORMALDISPLAY, hi2c);
...
void SSD1306_ON( I2C_HandleTypeDef hi2c) {
	SSD1306_WRITECOMMAND(0x8D, hi2c);
	SSD1306_WRITECOMMAND(0x14, hi2c);
	SSD1306_WRITECOMMAND(0xAF, hi2c);
}
void SSD1306_OFF(I2C_HandleTypeDef hi2c) {
	SSD1306_WRITECOMMAND(0x8D, hi2c);
	SSD1306_WRITECOMMAND(0x10, hi2c);
	SSD1306_WRITECOMMAND(0xAE, hi2c);
}
