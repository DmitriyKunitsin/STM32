...
{																																		\
	{ GPIO_ADC_SPD,					GPIO_MODE_OUTPUT_PP,	GPIO_PULLDOWN	| GPIO_PULL_INITSTATE_SET,		GPIO_SPEED_FREQ_LOW},		\
	{ GPIO_ADC_PWDWN,				GPIO_MODE_OUTPUT_PP,	GPIO_PULLDOWN	| GPIO_PULL_INITSTATE_SET,		GPIO_SPEED_FREQ_LOW},		\
	{ GPIO_MOTOR_PWR,				GPIO_MODE_OUTPUT_PP,	GPIO_PULLDOWN	| GPIO_PULL_INITSTATE_RESET,	GPIO_SPEED_FREQ_LOW},		\
	{ GPIO_MOTOR_REVERSE_ROT,		GPIO_MODE_OUTPUT_PP,	GPIO_PULLDOWN	| GPIO_PULL_INITSTATE_SET,		GPIO_SPEED_FREQ_LOW},		\
	{ GPIO_ADDRESS_0,				GPIO_MODE_OUTPUT_PP,	GPIO_PULLDOWN	| GPIO_PULL_INITSTATE_RESET,	GPIO_SPEED_FREQ_LOW},		\
	{ GPIO_ADDRESS_1,				GPIO_MODE_OUTPUT_PP,	GPIO_PULLDOWN	| GPIO_PULL_INITSTATE_RESET,	GPIO_SPEED_FREQ_LOW},		\
}
#else
#error Select platform!
...
typedef enum GPIO_CommonIndex_enum
{
	...
	iGPIO_TestPinADS1231		= iGPIO_NULL,
} GPIO_CommonIndex_t;
