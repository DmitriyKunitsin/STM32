...
// —борка MPU9250 (3xAccelerometer, 3xGyroscope, 3xMagnetometer)
// ќписание регистров
//
// ќсновано на MPU9250.h by Conor Forde 
// https://github.com/Snowda/MPU9250/blob/master/MPU9250.h
// [!!!] - изменения оригинала
...
// [!!!]
// ¬зяты адреса из документации на чип. ѕри работе с I2C необходимо сдвигать на 1 влево
...
#define MPU9250_POWER_MANAGMENT_1_RESET_VAL     0x01
#define MPU9250_DEFAULT_RESET_VALUE             0x00

#define MPU9250_WHOAMI_DEFAULT_VAL      0x68
...
#define MPU9250_GYRO_FULL_SCALE_bp      3		// bits position
...
#define MPU9250_FULL_SCALE_bp           3		// bits position
...
#define MPU9250_I2C_MST_CLK_348kHz		0x00
#define MPU9250_I2C_MST_CLK_333kHz		0x01
#define MPU9250_I2C_MST_CLK_320kHz		0x02
#define MPU9250_I2C_MST_CLK_308kHz		0x03
#define MPU9250_I2C_MST_CLK_296kHz		0x04
#define MPU9250_I2C_MST_CLK_286kHz		0x05
#define MPU9250_I2C_MST_CLK_276kHz		0x06
#define MPU9250_I2C_MST_CLK_267kHz		0x07
#define MPU9250_I2C_MST_CLK_258kHz		0x08
#define MPU9250_I2C_MST_CLK_500kHz		0x09
#define MPU9250_I2C_MST_CLK_471kHz		0x0A
#define MPU9250_I2C_MST_CLK_444kHz		0x0B
#define MPU9250_I2C_MST_CLK_421kHz		0x0C
#define MPU9250_I2C_MST_CLK_400kHz		0x0D
#define MPU9250_I2C_MST_CLK_381kHz		0x0E
#define MPU9250_I2C_MST_CLK_364kHz		0x0F
...
#define MPU9250_MAG_WIA_MASK			0x48

#define	MPU9250_MAG_ST1_DRDY			0x01	// Data Ready
#define	MPU9250_MAG_ST1_DOR				0x02	// Data Overrun
#define	MPU9250_MAG_ST1_DNEW			0x80	// !!! Data refresh - Soft Flag!

// [!!!]
// Code with class MPU9250 is fully skipped
// [!!!]
