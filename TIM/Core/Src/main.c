...
int main(void)
{
  ...
  while (1)
  {
//		uint8_t checkByte = TIM1->SR;
//		uint8_t value0Bite = (checkByte & ( 1 << 0)) >> 0;
		uint16_t checkCount = TIM1->CNT;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, OTG_FS_PowerSwitchOn_Pin|GPIO_PIN_1, GPIO_PIN_RESET);
